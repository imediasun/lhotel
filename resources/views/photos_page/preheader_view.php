...
<head>
    ...
    <!--Demo [ DEMONSTRATION ]-->
    <link href="/jasmine/css/demo/gamma-gallery.css" rel="stylesheet">



    <!--SCRIPT-->
    <!--=================================================-->
    <script src="/jasmine/plugins/gamma-gallery/js/modernizr.custom.70736.js"></script>

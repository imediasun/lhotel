...
<div class="modal fade" id="dayEdit" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title" id="myModalLabel">Редактирование календаря</h4>
            </div>
            <div class="modal-body">
                <input type="hidden" class="event_id">
                <div class="form-group">
                    <label>Заголовок</label>
                    <input type="text" class="form-control event_title">
                </div>
                <div class="form-group">
                    <label>Цена</label>
                    <input type="text" class="form-control event_price">
                </div>
                <div class="form-group">
                    <label>Статус</label>
                    <div class="radio">
                        <label><input type="radio" class="event_status" name="day_status" value="free" checked>Свободно</label>
                    </div>
                    <div class="radio">
                        <label><input type="radio" class="event_status" name="day_status" value="booked">Забронировано</label>
                    </div>
                    <div class="radio">
                        <label><input type="radio" class="event_status" name="day_status" value="sold">Продано</label>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Закрыть</button>
                <button type="button" class="btn btn-primary save_day">Сохранить</button>
            </div>
        </div>
    </div>
</div>
...
<script src="/jasmine/plugins/fullcalendar/lib/moment.min.js"></script>
<script src="/jasmine/plugins/fullcalendar/lib/jquery-ui.custom.min.js"></script>
<script src="/jasmine/plugins/fullcalendar/fullcalendar.min.js"></script>


<!--Full Calendar [ SAMPLE ]-->
<!--<script src="/jasmine/js/demo/fullcalendar.js"></script>-->
...
<script type="text/javascript" src="/js/jquery.damnuploader_update.js"></script>

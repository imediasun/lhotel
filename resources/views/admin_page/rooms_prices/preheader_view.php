...
<head>
    ...
    <link href="/jasmine/plugins/bootstrap-tagsinput/bootstrap-tagsinput.css" rel="stylesheet">

    <!--Jquery Tag It [ OPTIONAL ]-->
    <link href="/jasmine/plugins/tag-it/jquery.tagit.css" rel="stylesheet">

    <!--Ion.RangeSlider [ OPTIONAL ]-->
    <link href="/jasmine/plugins/ion-rangeslider/ion.rangeSlider.css" rel="stylesheet">
    <link href="/jasmine/plugins/ion-rangeslider/ion.rangeSlider.skinNice.css" rel="stylesheet">

    <!--Chosen [ OPTIONAL ]-->
    <link href="/jasmine/plugins/chosen/chosen.min.css" rel="stylesheet">

    <!--noUiSlider [ OPTIONAL ]-->
    <link href="/jasmine/plugins/noUiSlider/jquery.nouislider.min.css" rel="stylesheet">
    <link href="/jasmine/plugins/noUiSlider/jquery.nouislider.pips.min.css" rel="stylesheet">


    <!--Bootstrap Timepicker [ OPTIONAL ]-->
    <link href="/jasmine/plugins/bootstrap-timepicker/bootstrap-timepicker.min.css" rel="stylesheet">
    ...
    <!--Dropzone [ OPTIONAL ]-->
    <link href="/jasmine/plugins/dropzone/dropzone.css" rel="stylesheet">
